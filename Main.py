...
for city in cities:
    try:
        ...
        NOT_LOADED=True
        city_dict[city] = pl.DataFrame({"item_id": [], "city": [], "quality": [], "sell_price_min": [], "sell_price_min_date": [], "sell_price_max": [], "sell_price_max_date": [], "buy_price_min": [], "buy_price_min_date": [], "buy_price_max": [], "buy_price_max_date": []})
